                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="product-thumbs">
                                    <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                        <!-- :class = "thumbs" adalah fungsi agar jika di klik, maka akan ada garis luar berwarna, atau outline -->
...
export default {
  ...
  data() {
      return {
          ...
          thumbs: [
              "img/mickey1.jpg",
              "img/mickey2.jpg", //ini adalah untuk agar jika di klik gambarnya mengganti preview gambar utama
              "img/mickey3.jpg",
              "img/mickey4.jpg"
          ]
      }
  ...
  methods: {
      changeImage(urlImage) {
          this.gambar_default = urlImage; //ini functionnya untuk ganti foto preview
      }
  }
